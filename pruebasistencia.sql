...
-- Tiempo de generación: 29-10-2025 a las 07:32:10
...
CREATE TABLE IF NOT EXISTS `asistencia` (
  ...
  UNIQUE KEY `UKamecvn4u4pow3xcyic6hmhtl5` (`id_alumno`,`fecha`),
...
(65, 1, 1, '2025-10-29 05:42:56', '2025-10-28'),
(66, 2, 1, '2025-10-29 05:42:56', '2025-10-28'),
(67, 17, 1, '2025-10-29 05:42:56', '2025-10-28'),
(68, 18, 1, '2025-10-29 05:42:56', '2025-10-28'),
(69, 19, 3, '2025-10-29 05:42:56', '2025-10-28'),
(70, 20, 3, '2025-10-29 05:42:56', '2025-10-28'),
(71, 21, 2, '2025-10-29 05:42:56', '2025-10-28'),
(72, 22, 1, '2025-10-29 05:42:56', '2025-10-28'),
(73, 23, 1, '2025-10-29 05:42:56', '2025-10-28'),
(74, 24, 1, '2025-10-29 05:42:56', '2025-10-28'),
(75, 25, 1, '2025-10-29 05:42:56', '2025-10-28'),
(76, 26, 1, '2025-10-29 05:42:56', '2025-10-28'),
(77, 27, 1, '2025-10-29 05:42:56', '2025-10-28'),
(78, 28, 1, '2025-10-29 05:42:56', '2025-10-28'),
(79, 29, 1, '2025-10-29 05:42:56', '2025-10-28'),
(80, 30, 1, '2025-10-29 05:42:56', '2025-10-28');
...
CREATE TABLE IF NOT EXISTS `especialidad` (
  ...
  UNIQUE KEY `UKpwplro5muu5h10n9hqlocavfq` (`nombre`,`id_bachillerato`),
...
CREATE TABLE IF NOT EXISTS `seccion` (
  ...
  UNIQUE KEY `nombre` (`nombre`,`id_bachillerato`),
  UNIQUE KEY `UKa4qc3x5uedaifenjlitnfxkkj` (`nombre`,`id_bachillerato`),
  KEY `id_bachillerato` (`id_bachillerato`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `rol` enum('ADMINISTRADOR','PROFESOR') COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
